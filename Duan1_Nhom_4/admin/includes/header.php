...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="?page=home">KIM - WATCH</a>
        <a class="navbar-brand brand-logo-mini" href="?page=home"><img src="../content/assets/images/logo1.jpg" alt="logo"></a>
    </div>
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                    <a class="dropdown-item" href="#">
                        <i class="mdi mdi-cached me-2 text-success"></i> Đăng nhập tài khoản khác </a>
...
<div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="">
                    <span class="menu-title">Mẫu </span>
                    <i class="mdi mdi-truck menu-icon"></i>
                </a>
            </li> -->
        </ul>
